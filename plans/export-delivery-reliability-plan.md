...
- Status: P0-P4 complete. Runtime revision `78bfafeeb27f619e4df6f9af01cb768c9dacc55c` is published and installed, and the canary shape check passed. P5 production availability acceptance is blocked by repeated host OOM kills of the watcher; see the dated evidence and recovery checks below.
